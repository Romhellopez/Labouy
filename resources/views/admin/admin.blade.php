...
<html>
    ...
    <body>
		...
		<div class="lg:col-span-3 md:col-span-4 gap-5 mr-10">
				...
				{{-- @section('content') --}}
					<tbody>
						...
						<tr class=" border-b text-black">
							...
							<td class="py-4 px-3">
								<a class="btn btn-lg btn-accent text-dark font-bold px-10 py-2 mt-5"  href="/dashboard/admin/{{$hotels->id}}" type="submit" >Update</a>
								{{-- <form method="DELETE">
									@method('POST')
									@csrf
							...
							<div class="col-sm">
								<form action="/dashboard/hotel/{{$hotels->id}}" method="post">
									@csrf
									@method('DELETE')
									<button type="submit" class="btn btn-lg btn-accent text-dark font-bold px-10 py-2 mt-5">Delete</button>
								</form>
							</div>
			...
			<a class="btn btn-lg btn-accent text-white font-bold px-10 py-2 mt-5" href="/admin/create">Add</a>
			<section class="mt-10">
