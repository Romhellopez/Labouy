...
<div class='lg:ml-12 ml-6 mt-5'> 
    <div class='lg:ml-12 ml-6 mt-5'> 
        ...
        <input placeholder='Username' type="text" name="name"  class="bg-[#D9D9D9] rounded-lg w-[313px] h-[62px] font-semibold text-lg p-2" required value={{old('name')}}>
        @error('name')
        ...
        <div class='lg:ml-12 ml-6 mt-5'> 
          ...
          <input placeholder='Email' type="text" name="email"  class="bg-[#D9D9D9] rounded-lg w-[313px] h-[62px] font-semibold text-lg p-2" required value={{old('email')}}>
          @error('email')
              <p class="text-red-500 text-xs p-1">
                  {{$message}}
              </p>
...
<input placeholder='Password' type="password" name="password"  required  class="bg-[#D9D9D9] rounded-lg w-[313px] h-[62px] font-semibold text-lg p-2"/>
</div>
<div class='lg:ml-12 ml-6 mt-5 '>
    @error('password')
    <p class="text-red-500 text-xs p-1">
...
@enderror
  ...
  <input placeholder='Confirm Password' type="password" name="password_confirmation"   required class="bg-[#D9D9D9] rounded-lg w-[313px] h-[62px] font-semibold text-lg p-2"/>
  </div>
...
<div class="mt-12">
<p class="lg:ml-[90px] ml-[70px]">Already have an account? <span class="text-[#01DADA] font-semibold "><a href="/login">Login</a></span></p>
</div>
