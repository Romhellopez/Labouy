...
<img src={room01} class='lg:rounded-bl-xl w-[480px] lg:rounded-tl-xl'/>
...
<img src={room6} class='lg:rounded-bl-xl w-[480px] lg:rounded-tl-xl ' />
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
...
<img src={room7} class='lg:rounded-bl-xl w-[480px] lg:rounded-tl-xl '/>
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  <a href="#slide2" class="btn btn-outline btn-circle">❮</a> 
  <a href="#slide4" class="btn btn-outline btn-circle">❯</a>
</div>
...
<img src={room8} class='lg:rounded-bl-xl w-[480px] lg:rounded-tl-xl ' />
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  <a href="#slide3" class="btn btn-outline btn-circle">❮</a> 
  <a href="#slide1" class="btn btn-outline btn-circle">❯</a>
</div>
            ...
            <div class='grid lg:grid-cols-3 lg:ml-0 lg:gap-0 col-span-2 grid-cols-1 gap-5 ml-8'>
              <div  >
            <img src={room02} class='w-[300px] h-[220px] my-2'/>
            </div>
            <div>
            <img src={room03}  class='w-[300px] h-[220px] my-2 '/>
            </div>
            <div>
            <img src={room04} class='lg:rounded-tr-xl w-[300px] h-[220px] my-2'/>
            </div>
            <div >
            <img src={room05} class='w-[300px] h-[220px] my-2'/>
            </div>
            <div >
            <img src={room09} class='w-[300px]  h-[220x] my-2' />
            </div>
            <div>
            <img src={room011} class='lg:rounded-br-xl w-[300px] h-[225px] my-2'/>
            </div>
