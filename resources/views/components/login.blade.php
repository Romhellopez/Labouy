...
<input placeholder='Username' type="text" name="username"  class="bg-[#D9D9D9] rounded-lg w-[313px] h-[62px] font-semibold text-lg p-2"/>
...
<div class='my-2 font-semibold'>
  <p class="ml-[90px]">Don't have an account? <span class="text-[#01DADA]">Register</span></p>
