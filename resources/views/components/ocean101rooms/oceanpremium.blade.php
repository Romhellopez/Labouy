...
<img src="{{ asset('assets/roomimage/oceanroom14.webp')}}" class='lg:rounded-bl-xl w-[480px] lg:rounded-tl-xl ' />
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
...
<img src="{{ asset('assets/roomimage/oceanroom13.jpg')}}" class='lg:rounded-bl-xl w-[480px] lg:rounded-tl-xl'/>
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  <a href="#slide2" class="btn btn-outline btn-circle">❮</a> 
  <a href="#slide4" class="btn btn-outline btn-circle">❯</a>
</div>
...
<img src="{{ asset('assets/roomimage/oceanroom12.jpg')}}" class='lg:rounded-bl-xl w-[480px] lg:rounded-tl-xl' />
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  <a href="#slide3" class="btn btn-outline btn-circle">❮</a> 
  <a href="#slide1" class="btn btn-outline btn-circle">❯</a>
</div>
            ...
            <div class='grid lg:grid-cols-3 lg:ml-0 lg:gap-0 col-span-2 grid-cols-1 gap-5 ml-8'>
              <div  >
              <img src="{{ asset('assets/roomimage/oceanroom11.jpg')}}" class='w-[300px] h-[225px] '/>
            </div>
            <div class=' '>
            <img src="{{ asset('assets/roomimage/oceanroom10.jpg')}}" class=' w-[300px] h-[225px]'/>
            </div>
            <div class=' '>
            <img src="{{ asset('assets/roomimage/oceanroom9.jpg')}}" class='lg:rounded-tr-xl h-[225px] w-[300px]'/>
            </div>
            <div class='  '>
            <img src="{{ asset('assets/roomimage/oceanroom8.jpg')}}" class='h-[225px] w-[300px]' />
            </div>
            <div >
            <img src="{{ asset('assets/roomimage/oceanroom7.jpg')}}" class='w-[300px]  h-[225px]' />
            </div>
            <div class=' '>
            <img src="{{ asset('assets/roomimage/oceanroom6.jpg')}}" class='lg:rounded-br-xl w-[300px] h-[225px]'/>
            </div>
